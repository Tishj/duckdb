...
INSTANTIATE_VECTOR(std::vector<shared_ptr<Event>>)
INSTANTIATE_VECTOR(std::vector<unique_ptr<Pipeline>>)
INSTANTIATE_VECTOR(std::vector<shared_ptr<Pipeline>>)
INSTANTIATE_VECTOR(std::vector<weak_ptr<Pipeline>>)
INSTANTIATE_VECTOR(std::vector<shared_ptr<MetaPipeline>>)
...
INSTANTIATE_VECTOR(std::vector<shared_ptr<ColumnDataAllocator>>)
