...
void Node48::InsertChild(BaseNode *&node, uint8_t key_byte, BaseNode *new_child) {
	auto n = (Node48 *)node;
...
void Node48::EraseChild(BaseNode *&node, int pos, ART &art) {
	auto n = (Node48 *)(node);
...
bool Node48::Merge(MergeInfo &info, idx_t depth, BaseNode *&l_parent, idx_t l_pos) {
