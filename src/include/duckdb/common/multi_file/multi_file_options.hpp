...
struct MultiFileOptions {
	...
	DUCKDB_API void AutoDetectHivePartitioning(MultiFileList &files, MultiFileReader &multi_file_reader, ClientContext &context);
	DUCKDB_API static bool AutoDetectHivePartitioningInternal(MultiFileList &files, MultiFileReader &multi_file_reader, ClientContext &context);
	DUCKDB_API void AutoDetectHiveTypesInternal(MultiFileList &files, MultiFileReader &multi_file_reader, ClientContext &context);
