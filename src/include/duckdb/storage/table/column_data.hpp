...
public:
	...
	virtual void InitializeScan(ColumnScanState &state, SegmentLock &lock) const;
	...
	virtual void InitializeScanWithOffset(ColumnScanState &state, idx_t row_idx, SegmentLock &lock) const;
