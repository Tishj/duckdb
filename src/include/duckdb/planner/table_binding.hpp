...
struct Binding {
	Binding(const string &alias, vector<BindingColumnInfo> columns, idx_t index);
	...
	idx_t index;
	//! The name, type, index and category of the column
...
struct TableBinding : public Binding {
	TableBinding(const string &alias, vector<BindingColumnInfo> columns, LogicalGet &get, idx_t index, bool add_row_id = false);
