...
Optimizer::Optimizer(Binder &binder, ClientContext &context) : context(context), binder(binder), rewriter(context) {
	rewriter.rules.emplace_back(make_uniq<ConstantFoldingRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<DistributivityRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<ArithmeticSimplificationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<CaseSimplificationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<ConjunctionSimplificationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<DatePartSimplificationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<ComparisonSimplificationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<InClauseSimplificationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<EqualOrNullSimplification>(rewriter));
	rewriter.rules.emplace_back(make_uniq<MoveConstantsRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<LikeOptimizationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<OrderedAggregateOptimizer>(rewriter));
	rewriter.rules.emplace_back(make_uniq<RegexOptimizationRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<EmptyNeedleRemovalRule>(rewriter));
	rewriter.rules.emplace_back(make_uniq<EnumComparisonRule>(rewriter));
