...
class DuckDBPyConnection:
    ...
    def sql(self, query: str, *, alias: str = "", params: object = None, context: Optional[Dict[str, Any]] = None) -> DuckDBPyRelation: ...
    def query(self, query: str, *, alias: str = "", params: object = None, context: Optional[Dict[str, Any]] = None) -> DuckDBPyRelation: ...
    def from_query(self, query: str, *, alias: str = "", params: object = None, context: Optional[Dict[str, Any]] = None) -> DuckDBPyRelation: ...
...
def sql(query: str, *, alias: str = "", params: object = None, context: Optional[Dict[str, Any]] = None, connection: DuckDBPyConnection = ...) -> DuckDBPyRelation: ...
def query(query: str, *, alias: str = "", params: object = None, context: Optional[Dict[str, Any]] = None, connection: DuckDBPyConnection = ...) -> DuckDBPyRelation: ...
def from_query(query: str, *, alias: str = "", params: object = None, context: Optional[Dict[str, Any]] = None, connection: DuckDBPyConnection = ...) -> DuckDBPyRelation: ...
