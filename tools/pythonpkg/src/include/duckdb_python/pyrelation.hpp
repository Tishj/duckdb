...
public:
	...
	FromDf(const DataFrame &df, shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	static unique_ptr<DuckDBPyRelation>
	Values(py::object values = py::list(),
	...
	static unique_ptr<DuckDBPyRelation>
	RunQuery(const string &query, const string &alias,
	         shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());
	...
	static unique_ptr<DuckDBPyRelation>
	GetSubstraitJSON(const string &query,
	                 shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	static unique_ptr<DuckDBPyRelation>
	FromParquetDefault(const string &filename,
	                   shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	static unique_ptr<DuckDBPyRelation>
	FromArrow(py::object &arrow_object, shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	unique_ptr<DuckDBPyRelation> Project(const string &expr);

	static unique_ptr<DuckDBPyRelation>
	ProjectDf(const DataFrame &df, const string &expr,
	          shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());
	...
	static unique_ptr<DuckDBPyRelation>
	AliasDF(const DataFrame &df, const string &expr,
	        shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	unique_ptr<DuckDBPyRelation> Filter(const string &expr);

	static unique_ptr<DuckDBPyRelation>
	FilterDf(const DataFrame &df, const string &expr,
	         shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	unique_ptr<DuckDBPyRelation> Limit(int64_t n, int64_t offset = 0);

	static unique_ptr<DuckDBPyRelation>
	LimitDF(const DataFrame &df, int64_t n,
	        shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	unique_ptr<DuckDBPyRelation> Order(const string &expr);

	static unique_ptr<DuckDBPyRelation>
	OrderDf(const DataFrame &df, const string &expr,
	        shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());
	...
	static unique_ptr<DuckDBPyRelation>
	AggregateDF(const DataFrame &df, const string &expr, const string &groups = "",
	            shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());

	unique_ptr<DuckDBPyRelation> Distinct();

	static unique_ptr<DuckDBPyRelation>
	DistinctDF(const DataFrame &df, shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());
	...
	static unique_ptr<DuckDBPyResult>
	QueryDF(const DataFrame &df, const string &view_name, const string &sql_query,
	        shared_ptr<DuckDBPyConnection> conn = DuckDBPyConnection::DefaultConnection());
